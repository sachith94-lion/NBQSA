 ...
 * Version: 1.10.0
 * Description: Ultimate Addons is a premium extension for Elementor that adds 20 modules and works on top of any Elementor Package (Free, Pro). You can use it with any WordPress theme.
 * Text Domain: uael
 *
 * @package UAEL
 */
