...
class Image_Gallery extends Common_Widget {
	...
	protected function register_content_grid_controls() {
		$this->start_controls_section(
			...
			[
				...
				'tab'       => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'gallery_style' => [ 'grid', 'masonry', 'justified' ],
				],
			]
		);
			$this->add_responsive_control(
				...
				[
					...
					'condition'      => [
						'gallery_style!' => [ 'justified', 'carousel' ],
					],
				]
			);
	...
	protected function register_style_layout_controls() {
		...
		$this->add_responsive_control(
			'images_valign',
			[
				'label'     => __( 'Image Vertical Alignment', 'uael' ),
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector'  => '{{WRAPPER}} .uael-gallery-parent .uael-masonry-filters .uael-masonry-filter,{{WRAPPER}} .uael-img-gallery-tabs-dropdown .uael-filters-dropdown-button,{{WRAPPER}} .uael-img-gallery-tabs-dropdown .uael-filters-dropdown-button i',
				]
			);
			$this->add_responsive_control(
				'cat_filter_padding',
			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .uael-img-gallery-tabs-dropdown .uael-filters-dropdown-button, {{WRAPPER}} .uael-img-gallery-tabs-dropdown .uael-filters-dropdown-button i,{{WRAPPER}} .uael-gallery-parent .uael-masonry-filters .uael-masonry-filter' => 'color: {{VALUE}};',
						],
						'condition' => [
							'gallery_style'          => [ 'grid', 'masonry', 'justified' ],
							'masonry_filters_enable' => 'yes',
		...
		if ( ( 'grid' === $settings['gallery_style'] || 'masonry' === $settings['gallery_style'] || 'justified' === $settings['gallery_style'] ) && 'yes' === $settings['masonry_filters_enable'] ) {
			...
			if ( 'yes' == $settings['tabs_dropdown'] ) {
				...
				$filters_output .= '<div class="uael-filters-dropdown uael-masonry-filters" data-default="' . $default_cat . '">';
					...
					$filters_output .= '<div class="uael-filters-dropdown-button">' . $settings['filters_all_text'] . '<i class="fa fa-angle-down"></i></div>';
	...
	protected function render() {
		...
		echo '<div class="uael-gallery-parent uael-caption-' . $settings['gallery_caption'] . ' ' . $unjustified . '">';
