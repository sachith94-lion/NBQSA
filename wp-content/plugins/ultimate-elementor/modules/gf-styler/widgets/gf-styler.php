...
class GfStyler extends Common_Widget {
	 ...
	 * @access protected
	 */
	protected function render_gf_script() {
	...
	protected function register_general_content_controls() {
		...
		if ( parent::is_internal_links() ) {
			...
			$this->add_control(
				...
				[
					...
					'raw'             => sprintf( __( 'You need to change above tabindex value if pressing tab on your keyboard not works as expected. Please read %1$s this article %2$s for more information.', 'uael' ), '<a href="https://uaelementor.com/docs/gravity-form-tab-index/?utm_source=uael-pro-dashboard&utm_medium=uael-editor-screen&utm_campaign=uael-pro-plugin" target="_blank" rel="noopener">', '</a>' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Title & Description Alignment', 'uael' ),
				...
				'selectors' => [
					'{{WRAPPER}} .uael-gf-form-desc, {{WRAPPER}} .uael-gf-form-title, {{WRAPPER}} .uael-gf-style .gform_description' => 'text-align: {{VALUE}};',
				],
				'toggle'    => false,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .uael-gf-style .uael-gf-select-custom:after ' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					{{WRAPPER}} .uael-gf-select-custom + label' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function register_typography_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
				'selector' => '{{WRAPPER}} .uael-gf-style .gform_wrapper .gfield .gfield_description,{{WRAPPER}} .uael-gf-style .ginput_container_name input + label,{{WRAPPER}} .uael-gf-style .ginput_container_creditcard input + span + label,{{WRAPPER}} .uael-gf-style .ginput_container input + label,{{WRAPPER}} .uael-gf-style .ginput_container select + label, {{WRAPPER}} .uael-gf-style .ginput_container .chosen-single + label,{{WRAPPER}} .uael-gf-style .gfield_time_hour label,{{WRAPPER}} .uael-gf-style .gfield_time_minute label,{{WRAPPER}} .uael-gf-style .ginput_container_address label,{{WRAPPER}} .uael-gf-style .ginput_container_total span,{{WRAPPER}} .uael-gf-style .ginput_shipping_price,{{WRAPPER}} .uael-gf-select-custom + label',
			]
		);
