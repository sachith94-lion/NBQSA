...
class Skin_News extends Skin_Style {
	...
	public function render_featured_image() {
		...
		<div class="uael-post__thumbnail">
			<a <?php echo $this->get_render_attribute_string( 'img_link' . get_the_ID() ); ?>></a>
		</div>
		<?php
	...
	public function render_pagination() {
		...
		if ( $total_pages > 1 ) {
			...
			?>
			<nav class="uael-grid-pagination" <?php echo $class; ?> role="navigation" aria-label="<?php _e( 'Pagination', 'uael' ); ?>">
