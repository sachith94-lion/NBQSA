			...
			$this->start_controls_tab(
				...
				$this->add_control(
					...
					[
						...
						'type'      => Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .uael-posts-tabs-dropdown .uael-filters-dropdown-button,{{WRAPPER}} .uael-posts-tabs-dropdown .uael-filters-dropdown-button i,{{WRAPPER}} .uael-post__header-filter' => 'color: {{VALUE}};',
						],
						'condition' => [
							$this->get_control_id( 'show_filters' ) => 'yes',
							$this->get_control_id( 'post_structure' ) => [ 'masonry', 'normal' ],
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default'   => '|',
					'selectors' => [
						'{{WRAPPER}} .uael-post__terms-meta-cat a.uael-listing__terms-link:not(:last-child):after' => 'content: "{{VALUE}}"; margin: 0 0.4em;',
					],
					'condition' => [
						'post_type_filter' => 'post',
						$this->get_control_id( 'show_meta' ) => 'yes',
			...
			$this->add_control(
				...
				[
					...
					'default'   => '|',
					'selectors' => [
						'{{WRAPPER}} .uael-post__terms-meta-tag a.uael-listing__terms-link:not(:last-child):after' => 'content: "{{VALUE}}"; margin: 0 0.4em;',
					],
					'condition' => [
						'post_type_filter' => 'post',
						$this->get_control_id( 'show_meta' ) => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .uael-post__meta-data span:last-child' => 'margin-right: 0;',
				],
			]
		);
