			...
			if ( $thisbutton.is( '.single_add_to_cart_button' ) ) {
				...
				if ( variation_id != '') {
					jQuery.ajax ({
						url: uael.ajax_url,
						type:'POST',
						data:'action=uael_add_cart_single_product&product_id=' + product_id + '&variation_id=' + variation_id + '&quantity=' + quantity,
					...
					jQuery.ajax ({
						url: uael.ajax_url,
						type:'POST',
						data:'action=uael_add_cart_single_product&product_id=' + product_id + '&quantity=' + quantity,
