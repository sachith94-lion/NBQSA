 ...
 *
 * @package Joomunited\WPLatestPosts\Jutranslation
 */

namespace Joomunited\WPLatestPosts\Jutranslation;
...
class Jutranslation
{
    ...
    protected static function showViewForm()
    {
        ...
        // phpcs:ignore WordPress.Security.EscapeOutput -- Value not need to be escaped, it will cause wrong value
        echo '<textarea style="display: none" name="strings">' . htmlentities($strings) . '</textarea>';
        echo '</form>';
        //Add waiting image
        echo '<div style="text-align:center"><img src="' .
             esc_url(plugin_dir_url(self::$main_plugin_file)) . 'jutranslation/assets/images/preview_loader.gif"></div>';
